...
| Current Standards | **v2.1-final** (base 7 Jan 2026) + **errata3** (effective 30 Jun 2026 doc-level / 8 Jul 2026 spec register; scope: intl-payments creditor; **Aug 2026 repo additions**: signed idempotency-key responses on `GET /payments`/`/file-payments`, insurance backport — register entry to verify) |
...
| Post-Publication Register | Release Notes (platform deployments) + Errata (doc corrections); current errata = **v2.1-errata3** (auth-endpoints + bank-initiation + insurance since Aug 2026; other specs resolve to errata2/errata1/base) |
...
| **v2.1-errata3** | **30 Jun / 8 Jul 2026** (+ repo additions 15 Aug 2026) | **✓ CURRENT ERRATA** (2 published corrections: intl-payments creditor, SWIFT SR2026; Aug repo additions: signed idempotency-key responses, insurance backport — verify register) | v8 |
