...
> **Last verified: 31 August 2026** (community hub Release Notes & Errata register + erratas-registry source re-check; prior passes 17 Aug / 13 Jul / 10 Jun 2026) against the community hub Release Notes & Errata register, the erratas-registry source, and the OF Confluence errata pages. Current production standard is **v2.1-final** with **errata3** (spec-register effective 8 Jul 2026 for the original 2 corrections, **21 Aug 2026 for 3 corrections added since the 17 Aug pass**; doc-level effective 30 Jun 2026; supersedes errata2 of 7 May 2026 for the touched specs). No errata4 and no v2.2 published as of 31 Aug 2026 — errata3 itself grew in place; the community hub does not mint a new errata number for additions to an open group, so watch section counts, not just the number. Note: live API traffic is still dominated by v1.2 and v2.0 (v2.1 adoption nascent as of May 2026 data) — "Superseded" below means "not for new builds," not "out of live use."
