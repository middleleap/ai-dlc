---
name: npa-uae
description: New Product Approval (NPA) for a CBUAE-regulated bank. Use whenever a proposition, business problem, feature or amendment would put a new or changed financial product or service in front of customers — including Open Finance use cases (aggregation, payment initiation, TPP services), lending and card changes, pricing, new channels, third-party or outsourced delivery, and withdrawals. Provides the Business Proposition Form template with every field, the CBUAE anchor behind each, the sign-off routing, the BAU assessments, and how the Loom assembles the pack in discovery, turns it into the PA1/PA2 receipts, compiles approval conditions into controls, and schedules the post-implementation review. Triggers on "NPA", "new product approval", "business proposition form", "product committee", "can we launch this", "does this need approval", "amendment to an existing product", "withdraw a product".
---
