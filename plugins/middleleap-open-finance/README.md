...
| `npa-uae` | New Product Approval for a CBUAE-regulated bank — the Business Proposition Form (33 fields with guidance, Word template in `assets/`), the regulatory anchor behind each field, sign-off routing, the BAU assessments, a worked Open Finance example, and how the pack becomes the Loom's PA1/PA2 receipts with conditions compiled into the warp |
