...
>
> Demo runs use **synthetic stakeholders** — tag them `[synthetic]`. Zero real PII.

## Session

- **Prototype shown:** `wireframe.html` (+ `prototype.md`)
- **Stakeholders:** <named synthetic roles — e.g. consent ops analyst, care lead, compliance officer>
- **Format / date:** <walkthrough · think-aloud · recorded reaction>
...
|---|---|---|---|---|
| H1 | <role> `[synthetic]` | <confirmed/refuted/uncertain> | <quote or observed behaviour> | S-NNN |

## Outcome

- **Framing:** <held as-is / adjusted — say how>.
- **Carried to Develop:** <the open questions a stakeholder surfaced that the solution phase must answer>.
